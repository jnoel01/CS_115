...
# Favorite flavor of dorito : I don't like doritos, dorito=carb
# *****
...
class Term:
    ...
    def __call__(self, input): # myTerm(input)
        ...
        return   ((input**self.exp*self.coef)) #x=input
...
# exponent is strictly decreasing
    ...
    def __eq__(self, other): # myPoly == other
        ...
        if (other.polyList==self.polyList):
            return True
        else:
            return False
